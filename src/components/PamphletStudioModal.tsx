      ...
      <div className="bg-[#f0f0f0] border-2 border-[#275d1d] w-full max-w-5xl rounded-2xl shadow-2xl flex flex-col max-h-[96vh] overflow-hidden my-auto">
        ...
        <div className="bg-[#275d1d] text-white px-5 py-3.5 flex items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="bg-black/25 p-1 rounded-lg flex items-center gap-1 border border-white/20">
              <button
                type="button"
        ...
        <div className="bg-white border-b border-[#275d1d]/20 px-3 py-2 flex items-center gap-1.5 overflow-x-auto shrink-0 scrollbar-none">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap transition-all flex items-center gap-1.5 cursor-pointer ${
                  isActive
                    ...
                    : 'bg-[#e5e5e5] text-[#275d1d] hover:bg-[#d8d8d8]'
                }`}
              >
                <span
